...
document.addEventListener('DOMContentLoaded', function () {
  ...
  projectsSwiper.on('slideChange', function () {
    ...
    if (projectsSwiper.isBeginning) {
      ...
      prevButton.querySelector('.content-icon').style.stroke =
        colors.inactive.stroke;
      nextButton.style.borderColor = colors.active.border;
      nextButton.querySelector('.content-icon').style.stroke =
  ...
  function disableButton(button) {
    ...
    button.querySelector('.content-icon').style.stroke = colors.inactive.stroke;
  }

  function enableButton(button) {
    button.disabled = false;
    button.style.borderColor = colors.active.border;
    button.querySelector('.content-icon').style.stroke = colors.active.stroke;
  }
});
